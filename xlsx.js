...
*/
  ...
  function write_zip(wb, opts) {
    ...
    for (rId = 1; rId <= wb.SheetNames.length; ++rId) {
      ...
      zip.file(
        "xl/drawings/drawing" + rId + "." + wbext,
        write_drawing(images)
      );
      add_rels(rels, rId, "../drawings/drawing" + rId + "." + wbext, RELS.DRAW);
      zip.file(
        "xl/drawings/_rels/drawing" + rId + "." + wbext + ".rels",
        write_rels(draw_rels)
      );
      zip.file(
        "xl/worksheets/_rels/sheet" + rId + "." + wbext + ".rels",
        write_rels(rels)
      );
    ...
    for (var i = 0; i < images.length; i++) {
      ...
      if (pos.type === "twoCellAnchor") {
        ...
        twoCell +=
          "<xdr:to><xdr:col>" +
          toCol +
          "</xdr:col><xdr:colOff>248195</xdr:colOff><xdr:row>" +
          toRow +
          "</xdr:row><xdr:rowOff>152608</xdr:rowOff></xdr:to>";
        twoCell +=
          ...
          '">';
        twoCell +=
          '</xdr:cNvPr><xdr:cNvPicPr><a:picLocks noChangeAspect="1"/></xdr:cNvPicPr></xdr:nvPicPr>';
        twoCell +=
  ...
  // 				ct.comments.push(cf);
  // 				add_rels(rels, -1, "../comments" + rId + "." + wbext, RELS.CMNT);
  // 				need_vml = true;
  // 			}
  // 			if(ws['!legacy']) {
  ...
  // 		if(rels['!id'].rId1) zip_add_file(zip, get_rels_path(f), write_rels(rels));
  // 	}
